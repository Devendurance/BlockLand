  ...
  return (
    <div className='flex justify-between items-center px-20 py-3 border border-t-[#DDDDDD] fixed bottom-0 left-0 right-0 bg-white'>
      <div className='flex items-center space-x-6'>
        <p className='text-sm font-light'>© 2023 BlockLand Properties, Inc.</p>
      ...
      <div className='flex items-center space-x-6'>
        ...
        <div className='flex space-x-2'>
          <p className='text-sm font-light'>TLOS</p>
        </div>
        <div>
          <p className='text-sm font-light'>Powered by TELOS Blockchain</p>
        </div>
      </div>
    </div>
  )
